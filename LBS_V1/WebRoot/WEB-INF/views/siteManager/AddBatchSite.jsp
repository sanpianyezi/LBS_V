...
<div class="form-actions">
	<h4 color="green">站点批量导入:&nbsp;</h4>
	<h6 align="right"><a href="<%=request.getContextPath() %>/static/siteBatch.xls">下载导入模版</a></h6>
	</div>
	
	
	<form id="inputForm" class="form-horizontal" action="<%=request.getContextPath() %>/manger/uploadBatchSite" method="post" enctype="multipart/form-data" novalidate="novalidate">
...
<script type="text/javascript">top.$.jBox.closeTip();</script>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="siteBatch" name="siteBatch" class="input-xlarge " type="file" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" value="">
			</div>
		</div>
