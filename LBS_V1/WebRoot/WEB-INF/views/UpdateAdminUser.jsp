...
<body>
	...
	<form id="inputForm" class="form-horizontal" action="<%=request.getContextPath() %>/SaveAdminUser" method="post" enctype="multipart/form-data" novalidate="novalidate">
...
<script type="text/javascript">top.$.jBox.closeTip();</script>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="userName" name="userName" class="input-xlarge " type="text" value=${userInfo.userName} maxlength="100" disabled="disabled">
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="realName" name="realName" class="input-xlarge " type="text" value=${userInfo.realName} maxlength="100">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">手机号：</label>
			<div class="controls">
				<input id="telNo" name="telNo" class="input-xlarge " type="text" value=${userInfo.telNo} maxlength="11">
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<select id="powers" name="powers" class="input-xlarge " tabindex="-1" title=""  disabled>
					<option value=""></option>
					<option value="02" <c:if test="${userInfo.powers =='02'}">selected</c:if>>前端管理员</option>
				</select>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="cardNo" name="parentId" class="input-xlarge " type="text" value=${userInfo.parentId} maxlength="20" disabled="disabled" >
			</div>
		</div>
