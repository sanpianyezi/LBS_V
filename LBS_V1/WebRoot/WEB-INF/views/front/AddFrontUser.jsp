...
<body>
	...
	<form id="inputForm" class="form-horizontal" action="<%=request.getContextPath() %>/front/AddFrontUser" method="post" enctype="multipart/form-data" novalidate="novalidate">
...
<script type="text/javascript">top.$.jBox.closeTip();</script>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="userName" name="userName" class="input-xlarge " type="text"  maxlength="100">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">密码：</label>
			<div class="controls">
				<input id="passWord" name="passWord" class="input-xlarge " type="text"  maxlength="100">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">真实姓名：</label>
			<div class="controls">
				<input id="realName" name="realName" class="input-xlarge " type="text"  maxlength="100">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">手机号：</label>
			<div class="controls">
				<input id="telNo" name="telNo" class="input-xlarge " type="text"  maxlength="11">
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<select id="powers" name="powers" class="input-xlarge " tabindex="-1" title="" >
					<option value=""></option>
					<option value="00" selected="selected">普通用户</option>
					<option value="01" >采集员</option>
				</select>
			</div>
		</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="email" name="email" class="input-xlarge " type="text" value="" maxlength="128">
			</div>
		</div>
